  ...
  sectionLeft: [
     ...
     */
    {
      ...
      content: [
        ...
        {
          type: 'normal', 
          left: '参与开发实验室的大型项目（前端4人后端10人）。使用实验室自建的<em>Git</em>仓库进行版本控制，注重<em>代码可读性</em>，了解了多人合作项目的开发流程与规范。', 
          right: '', 
          showDot: true,
        },
      ]
...

    {
      ...
      content: [
        ...
        },
        {
          ...
          right: '<a href="https://github.com/metarock2017/ZDM/tree/master/game" target="_blank">Source</a>', 
          showDot: false,
          blod: true,
        },
        {
