  ...
  sectionLeft: [
     ...
     */
    {
      ...
      content: [
        ...
        {
          left: '<b>实习生</b> 十余人的纯前端组，技术栈涉及 Node 较多。最大收获是体验到了公司内的开发流程及规范，以及多人协作、需求评审等校内很难锻炼到的能力。截至目前参与了 3 个项目的开发：',
          right: '',
          showDot: false
        },
        {
        ...
        {
          left: '<b>企业微信机器人消息模块：</b><strong>个人独立负责。</strong>帮助管理人员在操作配置平台时周知其他成员。' +
            '自己实现的订阅者模式（支持推/拉两种事件监测方式），支持简易的自定义模版。',
          right: '',
          showDot: true
        },
        {
        ...
        },
        {
          left:
            ...
            '当时（大一）资历尚浅只是打杂，主要收获是对前端有了更全面的认识、确定了自己的学习的路径。',
          right: '',
          showDot: false
        }
      ]
