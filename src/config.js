  ...
  sectionLeft: [
     ...
     */
    {
      ...
      content: [
        ...
        {
          left:
            '<b>Web 研发部“技术总监”<small>（2018.6至今）</small></b> 工作站成立于2000年，共有成员80余人（Web 研发部20+），拥有PRD-UI-前后端开发-运营-迭代的完整开发流程。' +
        ...
        {
          left:
            '<b>实验室成员</b> 大一上和老师沟通加入的实验室。进入后参与开发前端4人后端10人的项目。使用<em>Git</em>进行版本控制，注重<em>代码可读性</em>。' +
  ...
  sectionRight: [
...

    {
      ...
      content: [
        ...
        {
          left:
            '<b>非技术方面：</b>喜欢看书（传记/纪实类）、喜欢旅行、日常健身、呆过院辩论队。喜欢与人交流、喜欢在不同领域折腾，对自己日后的发展有较明确的规划。',
          right: '',
          showDot: true
        },
        {
