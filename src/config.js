      ...
      content: [
        ...
        },
        {
          left: '<strong>Web 研发部“技术总监”<small>（2018.6至今）</small></strong> 工作站成立于2000年，共有成员80余人( Web 研发部20+)，拥有PRD-UI-前后端开发-运营-迭代的完整开发流程。' + 
                '我曾主持或参与开发5个完整项目，同时参与上线维护、重构代码、项目迁移等任务。', 
          right: '', 
          showDot: true,
        },
        {
  ...
  sectionRight: [
     ...
     */
    {
      ...
      content: [
        ...
        {
          left: '我的第一个真正的作品。与老师合作开发，<em>Flex弹性布局</em>，' + 
        ...
        },
        {
          left: '此项目是一年一版，拥有完整开发流程的桌面端页面。' + 
                ...
                '为了达到视觉的效果并保证性能，我首先大量使用了<em>CSS3</em>的特性并强制GPU渲染，其次在开发过程与产品视觉进行沟通，对界面进行了精细的优化。' + 
